...
const docTemplate = `{
    ...
    "paths": {
        "/cart": {
            "get": {
                "description": "Get the current user's cart. A session ID is created if one is not provided.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CheckoutForm"
                        }
                    }
                ],
                "responses": {
...
var SwaggerInfo = &swag.Spec{
	...
	Schemes:          []string{},
	Title:            "Noble API",
	Description:      "This is a sample server for a fake e-commerce store.",
